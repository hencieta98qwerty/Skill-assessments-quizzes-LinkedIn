...
#### Q2. What data structure does a binary tree degenerate to if it isn't balanced properly?
...
#### Q3. What statement about static methods is true?
...
#### Q24. What is the purpose of the `pass` statement in Python?
...
#### Q27. Given the following three list, how would you create a new list that matches the desired output printed below?
...
#### Q28. What happens when you use the built-in function all() on a list?
...
#### Q29. What is the correct syntax for calling an instance method on a class named Game?
...
#### Q30. What is the algorithmic paradigm of quick sort?
...
#### Q31. What is runtime complexity of the list's built-in `.append()` method?
...
#### Q32. What is key difference between a `set` and a `list`?
...
#### Q33. What is the definition of abstraction as applied to object-oriented Python?
...
#### Q34. What does this function print?
...
#### Q35. Suppose a Game class inherits from two parent classes: BoardGame and LogicGame. Which statement is true about the methods of an object instantiated from the Game class?
...
#### Q36. What does calling namedtuple on a collection type return?
...
#### Q37. What symbol(s) do you use to assess equality between two elements?
...
#### Q38. Review the code below. What is the correct syntax for changing the price to 1.5?
...
#### Q39. What value would be returned by this check for equality?
...
#### Q40. What does a class's `init()` method do?
...
#### Q41. What is the correct syntax for creating a variable that is bound to a dictionary?
...
#### Q42. What is the proper way to write a list comprehension that represents all the keys in this dictionary?
...
#### Q43. What is the purpose of the `self` keyword when defining or calling methods on an instance of an object?
...
#### Q44. What statement about the class methods is true?
...
#### Q45. What does it mean for a function to have linear runtime?
...
#### Q46. What is the proper way to define a function?
...
#### Q47. According to the PEP 8 coding style guidelines, how should constant values be named in Python?
...
#### Q48. Describe the functionality of a deque.
...
#### Q49. What is the correct syntax for creating a variable that is bound to a set?
...
#### Q50. What is the correct syntax for defining an `__init__()` method that takes no parameters?
...
#### Q51. Which of the following is TRUE About how numeric data would be organised in a binary Search tree?
...
#### Q52. When would you use a for loop?
...
#### Q53. What is the most self-descriptive way to define a function that calculates sales tax on a purchase?
...
#### Q54. What would happen if you did not alter the state of the element that an algorithm is operating on recursively?
...
#### Q55. What is the runtime complexity of searching for an item in a binary search tree?
...
#### Q56. What is the runtime complexity of adding an item to a stack and removing an item from a stack?
...
#### Q57. Which statement accurately describes how items are added to and removed from a stack?
...
#### Q58. Why is it considered good practice to open a file from within a Python script by using the `with` keyword?
...
#### Q59. Why would you use a virtual environment?
...
#### Q60. What is the correct way to run all the doctests in a given file from the command line?
...
#### Q62. What is the primary difference between lists and tuples?
...
#### Q63. What does a generator return?
...
#### Q64. What is the difference between class attributes and instance attributes?
...
#### Q65. What is the correct syntax of creating an instance method?
...
#### Q66. What is the correct way to call a function?
...
#### Q68. What is the correct syntax for replacing the string apple in the list with the string orange?
...
#### Q69. What will happen if you use a while loop and forget to include logic that eventually causes the while loop to stop?
...
#### Q70. Describe the functionality of a queue?
...
#### Q72. What is the correct syntax for adding a key called `variety` to the `fruit_info` dictionary that has a value of `Red Delicious`?
...
#### Q73. When would you use a `while` loop?
...
#### Q74. What is the correct syntax for defining an `__init__()` method that sets instance-specific attributes upon creation of a new class instance?
